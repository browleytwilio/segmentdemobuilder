    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="relative mt-16 overflow-hidden border-b border-white/[0.06] bg-gradient-to-r from-marketing-blue/10 via-marketing-purple/10 to-marketing-blue/10"
        >
